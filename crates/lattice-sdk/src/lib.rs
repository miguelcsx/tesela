...
//! Fluent builder API for defining Lattice ontologies in code.
//!
...
//!
//! ```rust
//! use lattice_sdk::{App, DatasourceBuilder, ObjectTypeBuilder, PropertyBuilder};
//! use lattice_core::DataType;
//!
...
pub use lattice_compiler::{CompileResult, Compiler};
pub use lattice_core::{ApiName, DataType, Error, LinkCardinality, Operation, PolicyEffect, Value};
pub use lattice_ir::{
