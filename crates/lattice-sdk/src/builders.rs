...
use lattice_core::{ApiName, DataType, LinkCardinality, Operation, PolicyEffect, Value};
use lattice_ir::{
...
pub struct ObjectTypeBuilder {
    ...
    lineage: Vec<lattice_ir::LineageEdge>,
...
impl ObjectTypeBuilder {
    ...
    /// Add a lineage edge.
    pub fn lineage(mut self, edge: lattice_ir::LineageEdge) -> Self {
...
pub struct UploadFlowBuilder {
    ...
    mappings: Vec<lattice_ir::ColumnMapping>,
    quality_rules: Vec<QualityRule>,
...
impl UploadFlowBuilder {
    ...
    pub fn mapping(
        ...
        self.mappings.push(lattice_ir::ColumnMapping {
...
pub struct PolicyBuilder {
    ...
    row_filter: Option<lattice_ir::Filter>,
    redactions: Vec<ApiName>,
    obligations: Vec<lattice_ir::Obligation>,
}
...
impl PolicyBuilder {
    ...
    /// Set row filter.
    pub fn row_filter(mut self, filter: lattice_ir::Filter) -> Self {
...
impl RoleBuilder {
    ...
    /// Build the [`Role`].
    pub fn build(self) -> lattice_ir::Role {
        lattice_ir::Role {
            api_name: self.api_name,
            display: self.display,
            description: self.description,
