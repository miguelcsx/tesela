//! C ABI bridge for the Lattice runtime.
//!
...
//!   **must** free them with [`lattice_string_free`].
//! * Binary blobs are returned as [`LatticeBuffer`].  Callers **must** free
//!   them with [`lattice_buffer_free`].
...
pub use handle::{CallbackFn, LatticeBuffer};
