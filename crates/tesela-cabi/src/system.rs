...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tesela_runtime_agent_start_json(
    handle: u64,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tesela_runtime_agent_get_run_json(
    handle: u64,
    run_id: *const c_char,
) -> TeselaBuffer {
    let mut ht = lock_handles!(or return TeselaBuffer::empty());
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tesela_runtime_health_json(handle: u64) -> TeselaBuffer {
    let mut ht = lock_handles!(or return TeselaBuffer::empty());
    let rt = match ht.get(handle).cloned() {
        Some(r) => r,
        None => {
...
/// `handle` must be valid.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tesela_runtime_capabilities_json(handle: u64) -> TeselaBuffer {
    let mut ht = lock_handles!(or return TeselaBuffer::empty());
    let rt = match ht.get(handle).cloned() {
        Some(r) => r,
        None => {
...
/// [`tesela_runtime_register_backend`], [`tesela_runtime_register_action_handler`],
/// or [`tesela_runtime_register_custom_tool`], and not already freed.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tesela_callback_free(ptr: *mut c_char) {
    if !ptr.is_null() {
...
/// and must return JSON responses. Use [`tesela_callback_free`] to free the
/// returned pointer.
///
/// # Safety
/// `handle` must be valid; `adapter_type` a null-terminated C string.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tesela_runtime_register_backend(
    handle: u64,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tesela_runtime_register_action_handler(
    handle: u64,
    kind: *const c_char,
    callback: CallbackFn,
    user_data: *mut c_void,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tesela_runtime_register_custom_tool(
    handle: u64,
    name: *const c_char,
    callback: CallbackFn,
    user_data: *mut c_void,
...
/// `handle` must be valid.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tesela_runtime_register_object_store(
    handle: u64,
    name: *const c_char,
    callback: CallbackFn,
    user_data: *mut c_void,
...
/// `handle` must be valid.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tesela_runtime_register_message_bus(
    handle: u64,
    name: *const c_char,
    callback: CallbackFn,
    user_data: *mut c_void,
...
/// `handle` must be valid.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tesela_runtime_register_run_store(
    handle: u64,
    name: *const c_char,
    callback: CallbackFn,
    user_data: *mut c_void,
...
/// `handle` must be valid.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tesela_runtime_register_capability_issuer(
    handle: u64,
    name: *const c_char,
    callback: CallbackFn,
    user_data: *mut c_void,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn tesela_runtime_register_action(
    handle: u64,
