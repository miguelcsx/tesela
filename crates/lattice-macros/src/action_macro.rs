...
pub(crate) fn expand(args: TokenStream, input: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        ...
        impl #action_struct_name {
            /// Return the Lattice `ActionType` definition for this action.
            pub fn lattice_action_type() -> ::lattice_ir::ActionType {
                let props: std::collections::HashMap<String, serde_json::Value> =
                    vec![ #(#schema_props),* ].into_iter().collect();
                ::lattice_ir::ActionType {
                    ...
                    subject: None,
                    handler: ::lattice_ir::ActionHandler {
                    ...
                    input_schema: if props.is_empty() {
                        ...
                        Some(::lattice_core::Value::new(serde_json::json!({
                            "type": "object",
                            "properties": props,
                        })))
                    },
