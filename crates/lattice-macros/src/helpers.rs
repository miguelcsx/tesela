...
/// Map a Rust type path (as a string slice) to a `lattice_core::DataType` variant.
pub(crate) fn rust_type_to_data_type(ty_str: &str) -> proc_macro2::TokenStream {
    match ty_str
        ...
        .trim()
    {
        "String" | "&str" | "str" => quote!(::lattice_core::DataType::String),
        "i8" | "i16" | "i32" | "i64" | "u8" | "u16" | "u32" | "u64" | "usize" | "isize" => {
            quote!(::lattice_core::DataType::Integer)
        }
        "f32" | "f64" => quote!(::lattice_core::DataType::Float),
        "bool" => quote!(::lattice_core::DataType::Boolean),
        "uuid::Uuid" | "Uuid" => quote!(::lattice_core::DataType::Uuid),
        "serde_json::Value" | "Value" => quote!(::lattice_core::DataType::Json),
        _ => quote!(::lattice_core::DataType::String),
    }
}
