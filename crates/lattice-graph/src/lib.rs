//! Schema graph analysis for Lattice ontologies.
//!
...
use lattice_core::{ApiName, Diagnostic, DiagnosticCode};
use lattice_ir::{LinkType, ObjectType, Spec};
...
impl SchemaGraph {
    ...
    pub fn compute_lineage(&self, obj: &ApiName) -> Vec<lattice_ir::LineageEdge> {
...
mod tests {
    use super::*;
    use lattice_core::LinkCardinality;
    use lattice_ir::{LinkMapping, LinkType, ObjectSource, ObjectType, Property, Workspace};
