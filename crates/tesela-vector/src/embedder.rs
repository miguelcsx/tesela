...
//!
//! Re-exports the [`Embedder`] port trait from `tesela-runtime` and provides
//! a [`NoopEmbedder`] for tests.

use tesela_core::Error;

/// Re-export so callers can use `tesela_vector::Embedder` directly.
pub use tesela_runtime::ports::Embedder;
