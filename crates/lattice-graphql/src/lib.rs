...
//! GraphQL integration for the Lattice runtime.
//!
...
use lattice_ir::{AggregateView, ArtifactType, JobType, ObjectType, Spec, UploadFlow};
use lattice_runtime::{
    ports::ActorResolver,
...
/// Builds a `async-graphql` dynamic `Schema` from a Lattice spec.
...
mod tests {
    ...
    fn test_build_empty_schema() {
        ...
        let opts = lattice_runtime::runtime::RuntimeOptions::dev();
