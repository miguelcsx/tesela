...
/// Map a Rust type path (as a string slice) to a `tesela_core::DataType` variant.
pub(crate) fn rust_type_to_data_type(ty_str: &str) -> proc_macro2::TokenStream {
    match ty_str
        ...
        .trim()
    {
        "String" | "&str" | "str" => quote!(::tesela_core::DataType::String),
        "i8" | "i16" | "i32" | "i64" | "u8" | "u16" | "u32" | "u64" | "usize" | "isize" => {
            quote!(::tesela_core::DataType::Integer)
        }
        "f32" | "f64" => quote!(::tesela_core::DataType::Float),
        "bool" => quote!(::tesela_core::DataType::Boolean),
        "uuid::Uuid" | "Uuid" => quote!(::tesela_core::DataType::Uuid),
        "serde_json::Value" | "Value" => quote!(::tesela_core::DataType::Json),
        _ => quote!(::tesela_core::DataType::String),
    }
}
