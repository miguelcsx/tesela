//! Typed errors for the Lattice runtime.
//!
//! Every public function in the Lattice ecosystem returns `Result<T, Error>`.
//! This crate never uses `anyhow` in library surfaces.

use std::fmt;
use thiserror::Error;

/// The primary error type for Lattice operations.
