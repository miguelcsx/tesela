//! Time-ordered unique ID generation for Tesela.
//!
...
// ---------------------------------------------------------------------------
// UlidIdGenerator — implements tesela_runtime::ports::IdGenerator
// ---------------------------------------------------------------------------

/// [`IdGenerator`] implementation backed by ULID.
///
/// The optional `prefix` passed to `new_id` is prepended
/// followed by `_`, e.g. `run_01HXYZ…`.
///
/// [`IdGenerator`]: tesela_runtime::ports::IdGenerator
...
// Implement the tesela_runtime IdGenerator port directly so callers can
// plug this in without any glue.
impl tesela_runtime::ports::IdGenerator for UlidIdGenerator {
...
mod tests {
    ...
    fn ulid_generator_prefixes() {
        ...
        use tesela_runtime::ports::IdGenerator;
