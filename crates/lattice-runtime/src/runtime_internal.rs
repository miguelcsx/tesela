...
pub(crate) fn apply_redactions(record: &mut lattice_ir::Record, fields: &[ApiName]) {
    for field in fields {
...
pub(crate) fn mutation_to_record(mutation: &Mutation) -> lattice_ir::Record {
