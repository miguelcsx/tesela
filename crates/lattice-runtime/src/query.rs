//! Query and data types for the Lattice runtime.
...
impl Query {
    ...
    #[must_use]
    pub fn and_filter(mut self, additional: lattice_ir::Filter) -> Self {
        self.filter = Some(match self.filter.take() {
            Some(existing) => lattice_ir::Filter::and(vec![existing, additional]),
            None => additional,
        });
        self
    }
...
pub struct AggregateQuery {
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub time_bucket: Option<lattice_ir::TimeBucket>,
    /// Optional spatial extent descriptor.
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub spatial_extent: Option<lattice_ir::SpatialExtent>,
...
pub struct CapabilityToken {
    ...
    /// Allowed operations.
    #[serde(default)]
    pub operations: Vec<lattice_core::Operation>,
    /// Resource kind.
...
pub struct PolicyRequest {
    ...
    pub operation: lattice_core::Operation,
