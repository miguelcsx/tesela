...
pub trait ActionHandler: Send + Sync {
    /// Execute the action.
    fn execute(&self, req: ActionRequest) -> Result<lattice_ir::ActionResult, Error>;
}
...
pub trait ObjectStore: Send + Sync {
    ...
    fn signed_upload_url(
        ...
        path: &str,
        ttl_secs: u64,
        metadata: &std::collections::BTreeMap<String, lattice_core::Value>,
...
pub trait CapabilityIssuer: Send + Sync {
    ...
    fn issue_capability(
        ...
        actor: &Actor,
        constraints: std::collections::BTreeMap<String, lattice_core::Value>,
