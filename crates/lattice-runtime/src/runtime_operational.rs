            ...
            aggregations: view
                ...
                .map(|m| Aggregation {
                    function: match m.function {
                        lattice_ir::AggregateFunction::Count => "count",
                        lattice_ir::AggregateFunction::Sum => "sum",
                        lattice_ir::AggregateFunction::Avg => "avg",
                        lattice_ir::AggregateFunction::Min => "min",
                        lattice_ir::AggregateFunction::Max => "max",
                        lattice_ir::AggregateFunction::CountDistinct => "count_distinct",
                        lattice_ir::AggregateFunction::SpatialExtent => "spatial_extent",
                    }
                    .to_string(),
