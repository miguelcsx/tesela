...
//! In-memory backend adapter for Lattice.
//!
...
pub use registry::{memory_capabilities, DefaultBackendRegistry, MemoryBackendFactory};

use lattice_ir::Record;
use lattice_runtime::query::Sort;
